      ...
      <div className="relative z-10 px-6 sm:px-12 lg:px-20 pt-4 pb-8 lg:pb-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center flex-1">
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="w-10 h-10 rounded-full bg-white/20 border border-white/30 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
            ...
            >
              ...
              >
                ...
                <div className="absolute top-1.5 right-1.5 w-7 h-7 rounded-full bg-white text-[#1E5BF9] flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
              ...
              <div className="flex-1">
                <div className="text-[10px] sm:text-[11px] font-semibold text-slate-400 mb-2 uppercase tracking-wider">
                  Results we are proud of
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    <div className="text-lg sm:text-xl font-extrabold text-[#1E5BF9] font-heading leading-tight">
                      12+
                    </div>
          ...
          >
            <div>
              ...
              <p className="mt-5 text-sm xl:text-base text-blue-100 max-w-xs leading-relaxed font-normal">
