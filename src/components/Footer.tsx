...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#070E20] text-white rounded-t-[36px] sm:rounded-t-[48px] pt-16 sm:pt-20 pb-10 px-6 sm:px-12 lg:px-20 mt-16 sm:mt-24 relative z-20">
